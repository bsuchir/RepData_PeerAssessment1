...
library(knitr)
knitr::opts_chunk$set(echo = TRUE, fig.path='\figure', fig.keep='all', fig.show='asis')
```
...
library(dplyr)
library(ggplot2)
setwd("C:/Users/Suchi/Documents/Data_scientist_toolbox/RepData_PeerAssessment1-master/RepData_PeerAssessment1-master/")
